...
function updateCar()
	...
	if (row~=-1) and (col~=-1) then
		guiSetText(lCost, "Cost: 95$")
		
		if not exports.global:hasMoney(getLocalPlayer(), 95) and exports.global:hasItem(getLocalPlayer(), 3, guiGridListGetItemText(gCars, row, IDcolumn)) then
