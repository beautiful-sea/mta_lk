...
function callbackQuitFaction()
	...
	local factionID = getElementData(source, "faction")
	if factionID ==1 or factionID ==2 then
		if exports.global:hasItem(source,63+factionID) then
			exports.global:takeItem(source,63+factionID)
		else
			outputChatBox("Return your badge if you want to leave faction.",source,244,244,244)
			return
		end
	end
...
joboppur = createMarker (1469.392578125, -1768.2529296875, 17.795755386353, "cylinder", 1.8, 255, 0, 250, 250)
	...
	--if (exports.global:isPlayerAdmin(thePlayer)) then
		...
		if result then
			...
			showCursor(thePlayer,true)
				outputChatBox("San Andreas Job Opportunity.", thePlayer, 255, 255, 0)
		else
...
addEventHandler( "onMarkerHit",joboppur,adminShowFactions)
