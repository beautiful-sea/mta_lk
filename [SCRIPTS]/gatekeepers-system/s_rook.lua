rook = createPed (21,2171.2578125, -1616.810546875, 14.268)
exports.pool:allocateElement(rook)

setPedRotation(rook, 71)
...
function rookIntro () -- When player enters the colSphere create GUI with intro output to all local players as local chat.
	...
	--else
		...
		if not (factionType==0) then
			exports.global:sendLocalText(source, "Rook says: Keep walking.", 255, 255, 255, 10)
			outputChatBox("You need to be in gang faction to deal with this NPC.Join at red marker nearby",source,255,0,0)
		else
