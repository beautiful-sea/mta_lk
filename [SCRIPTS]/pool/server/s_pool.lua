...
function showsize(thePlayer)
	...
	outputChatBox("JOGADORES: " .. tostring(players) .. ":" .. tostring(tplayers), thePlayer)
	outputChatBox("VEÍCULOS: " .. tostring(vehicles) .. ":" .. tostring(tvehicles), thePlayer)
	--outputChatBox("COLSHAPES: " .. tostring(colshapes) .. ":" .. tostring(tcolshapes), thePlayer)
	--outputChatBox("PEDESTRES: " .. tostring(peds) .. ":" .. tostring(tpeds), thePlayer)
	outputChatBox("MARCADORES: " .. tostring(markers) .. ":" .. tostring(tmarkers), thePlayer)
	outputChatBox("OBJETOS: " .. tostring(objects) .. ":" .. tostring(tobjects), thePlayer)
