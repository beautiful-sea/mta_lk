local pdgates = 
{
	...
	{
		{ createObject(1495, 222.11375427246, 116.68622589111, 997.99969482422, 0, 0, 90), 90 }
	}
}
...
local function openDoor(thePlayer)
	if getElementDimension(thePlayer) == 1 and getElementInterior(thePlayer) == 10 and exports.global:hasItem(thePlayer, 64) then
