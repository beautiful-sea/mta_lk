local g_achievements = {
	...
	{ "The Beta Blues", "Took part in a ShoDown MTA Beta Test.", 100 },
	...
	{ "Donator", "Donate to ShoDown Gaming Roleplay.Thank You!", 100 },
	{ "Cashin Cheques", "Get a job.", 20 },
	{ "Bank Heist", "Rob the bank.", 20 },
	{ "From ShoDown With Love", "Special thanks to the MTA team for their continous hard work.", 50 },
	{ "Pirate", "Took part in the ShoDown  Treasure Hunt Event.", 25 },
	{ "No.1 Pirate", "Completed the ShoDown  Treasure Hunt Event.", 25 },
	...
	{ "10$ Payday", "Getting payday of $10 state benefit.", 25}
}
--last achieve 48
