	...
	if (report) then
		...
		showCursor(false)
			...
			if (wHelp==nil) then
				...
				wHelp = guiCreateWindow(0.2, 0.2, 0.7, 0.6, "Report Player/Help", true)
				...
				lPlayerName = guiCreateLabel(0.025, 0.15, 1.0, 0.3, "Playername you want to report:", true, wHelp)
...
addCommandHandler("report",adminReportUI)
