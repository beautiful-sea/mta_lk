...
local routes = {
	...
	{ 1220.954711,-1475.691528,12.961227}, -- st.,lawrence
...
addEvent("displaytruck", true)
addEventHandler("displaytruck", getRootElement(),displayTruckerJob)
	...
	if jobstate == 2 or jobstate == 3 then
		...
		if vehicle and getVehicleController(vehicle) == localPlayer and truck[getElementModel(vehicle)] then
			...
			elseif health >= 350 then
				...
				pay = math.ceil( 10 * ( health - 300 ) / 500 ) * 10
			else
				pay = 0
			end
