...
function quitJob(job)
	...
	elseif (job==7) then -- SWEEP
		outputChatBox("You have now quit your job as a sweeper.", 0, 255, 0)
	elseif (job==8) then -- PHOTO
		outputChatBox("You have now quit your job as a photographer.", 0, 255, 0)
	elseif (job==9) then -- PIZZA
		outputChatBox("You have now quit your job as a pizza deliverer.", 0, 255, 0)
	else
		outputChatBox("You have now quit your current job.", 0, 255, 0)
	end
end
