...
local victoria = createPed(188, 1650.263671875, -1659.6923828125, 22.515625)
setPedRotation(victoria, 178)
setElementFrozen(victoria, true)
setPedAnimation ( victoria,"DEALER", "DEALER_IDLE_01", -1, true, false, false )
setElementData( victoria, "talk", 1 )
setElementData( victoria, "name", "Mark Smith" )

--[[local victoria = createPed(141, 1338.35, -965.45, 413.91)
setPedRotation(victoria, 90)
setPedFrozen(victoria, true)
setPedAnimation ( victoria, "DEALER", "DEALER_IDLE_01", -1, true, false, false )
setElementData( victoria, "talk", 1 )
setElementData( victoria, "name", "Mark Smith" )]]
			...
			local factionType = getElementData(theTeam, "type")
		 	...
		 	if (job == 8) then 
				if (weapon == 43) then
					...
					outputChatBox("#FF9933Collection value: $"..collectionValue/4, 255, 104, 91, true)
				end
			end
		end
	end
