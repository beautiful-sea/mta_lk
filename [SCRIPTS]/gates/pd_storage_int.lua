local gates =
{
	{ gate = createObject( 971, 1216.04, -1189.56, 4980.90, 0, 0, 90 ), offset = { 0, -8.8, 0, 0, 0, 0 } } 
}

for _, gate in pairs(gates) do
	setElementInterior(gate.gate, 14)
	setElementDimension(gate.gate, 1699)
end
...
local function openDoor(thePlayer, commandName, pass)
	if getTeamName(getPlayerTeam(thePlayer)) == "Los Santos Police Department" and getElementDimension(thePlayer) == 1699 then
