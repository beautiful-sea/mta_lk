...
local font2 = dxCreateFont("font/font.ttf", 10)
--[[*************************************************************************
*
        ...
        if #dxGridW.items > 0 then
            ...
            for index, data in ipairs ( dxGridW.items ) do
                ...
                if data.vis then
                    ...
                    -- Draw the column bar
                    dxDrawRectangle ( data.x, data.y, data.w, 30 % data.h, tocolor ( 0,0,0,100 ), data.pg );
                    ...
                    if data.se and data.se <= data.r and data.se >= seeFrom and data.se <= seeTo then
                        ...
                        dxDrawRectangle ( data.x, ( 30 % data.h ) + y2, data.w, 20, tocolor ( 0,255,0,100 ), data.pg );
                    end
                                    ...
                                    for iIndex = seeFrom, seeTo do
                                        ...
                                        if cData[iIndex] then
                                         ...
                                         --   dxDrawImage( x+150, y+15, 900, 2, "linea.png", 0,0,0 ,tocolor(255,255,255,105))
                                            ...
                                            dxDrawText ( cData[iIndex]["text"], x, y, cData.info.width + x, ( 30 % data.h ) + y, tocolor ( unpack ( cData[iIndex]["color"] ) ), FIT_MODE and ( 1 * SCALE ) or 1, font, "center", "center", false, false, data.pg, false, false );
                                            end
                                        end
                                    end
                                end
